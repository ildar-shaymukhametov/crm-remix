...
{
    public partial class rename_claim_types2 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 16, "Company.New.SetManagerToAny", "Company.New.SetManagerToAny" },
                    { 17, "Company.New.SetManagerToSelf", "Company.New.SetManagerToSelf" }
                });
        }
    }
}
