...
public class GetNewCompanyQueryTests : BaseTest
{
    ...
    {
        await _fixture.RunAsDefaultUserAsync(new[] { Domain.Constants.Claims.Company.Create });
    ...
    {
        await _fixture.RunAsDefaultUserAsync(new[] { Domain.Constants.Claims.Company.Create, Domain.Constants.Claims.Company.New.Other.Set });
    ...
    {
        await _fixture.RunAsDefaultUserAsync(new[] { Domain.Constants.Claims.Company.Create, claim });
    ...
    {
        var user = await _fixture.RunAsDefaultUserAsync(new[] { Domain.Constants.Claims.Company.Create, Domain.Constants.Claims.Company.New.Manager.SetToSelf });
        var actual = await _fixture.SendAsync(new GetNewCompanyQuery());
    ...
    {
        await _fixture.RunAsDefaultUserAsync(new[] { Domain.Constants.Claims.Company.Create, Domain.Constants.Claims.Company.New.Manager.SetToSelf });
        var actual = await _fixture.SendAsync(new GetNewCompanyQuery());
        Assert.Empty(actual.InitData.CompanyTypes);
    }
    ...
    {
        await _fixture.RunAsDefaultUserAsync(new[] { Domain.Constants.Claims.Company.Create, Domain.Constants.Claims.Company.New.Manager.SetToAny });
        var actual = await _fixture.SendAsync(new GetNewCompanyQuery());
        Assert.Empty(actual.InitData.CompanyTypes);
    }
